  ...
  return (
    <div className='my-50'>
        ...
        <div className='flex flex-col  '>
            <h1 className='flex items-center justify-center lg:text-4xl lg:font-bold'> My <span className='text-[#2463EB]'>Skills</span></h1>


            <div className='flex items-center justify-center lg:gap-6 lg:mt-12'>
                <div className='flex flex-col lg:gap-1.5 lg:w-[420PX] lg:min-h-[200px] rounded-xl bg-[#4b55630b]  lg:py-3.5 lg:pl-8 lg:pr-36 '>
